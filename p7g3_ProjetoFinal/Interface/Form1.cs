...
namespace Interface
{
    public partial class Form1 : Form
    {
        ...
        {
            // CN = new SqlConnection("Data Source = " + "tcp:mednat.ieeta.pt" + @"\" + "SQLSERVER,8101" + " ;" + "Initial Catalog = " + "NOME" + "; uid = " + "NOME" + ";" + "password = " + "PASS");
            CN = new SqlConnection("Data Source=localhost;Initial Catalog=centro_comercial;Integrated Security=True");
            try
            {
                CN.Open();
